package com.tecra.user.apirest.user.controller;

import java.util.List;

import com.tecra.user.apirest.common.BaseController;
import com.tecra.user.apirest.common.dto.SuccessMessageDto;
import com.tecra.user.apirest.user.dto.UserRequestDto;
import com.tecra.user.apirest.user.dto.UserResponseDto;
import com.tecra.user.apirest.user.dto.UserToPatchRequestDto;
import com.tecra.user.apirest.user.mapper.UserMapper;
...
import com.tecra.user.domain.usecase.UpdateUserUseCase;
...
public class UserController extends BaseController {
  ...
  private static final String USER_CREATED_SUCCESSFULLY = "El usuario ha sido creado satisfactoriamente";

  private static final String USER_UPDATED_SUCCESSFULLY = "El usuario ha sido actualizado satisfactoriamente";

  private static final String USER_DELETED_SUCCESSFULLY = "El usuario ha sido eliminado satisfactoriamente";
