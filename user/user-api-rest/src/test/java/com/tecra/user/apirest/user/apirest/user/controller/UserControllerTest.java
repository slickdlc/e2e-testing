package com.tecra.user.apirest.user.apirest.user.controller;
...
import com.tecra.user.apirest.user.controller.UserController;
import com.tecra.user.apirest.user.apirest.user.dto.UserRequestDtoMother;
import com.tecra.user.apirest.user.mapper.UserMapperImpl;
...
class UserControllerTest {
  ...
  class CreateUser {
    ...
    void given_useCaseWorks_when_createUser_then_returnExpectedMessage() {
      ...
      assertEquals(HttpStatus.OK, result.getStatusCode());
      assertNotNull(result.getBody());
      assertEquals("El usuario ha sido creado satisfactoriamente", result.getBody().getMessage());
  ...
  class UpdateUser {
    ...
    void given_useCaseWorks_when_updateUser_then_returnExpectedMessage() {
      ...
      assertEquals(HttpStatus.OK, result.getStatusCode());
      assertNotNull(result.getBody());
      assertEquals("El usuario ha sido actualizado satisfactoriamente", result.getBody().getMessage());
  ...
  class DeleteUser {
    ...
    void given_useCaseWorks_when_deleteUser_then_returnExpectedMessage() {
      ...
      assertEquals(HttpStatus.OK, result.getStatusCode());
      assertNotNull(result.getBody());
      assertEquals("El usuario ha sido eliminado satisfactoriamente", result.getBody().getMessage());
